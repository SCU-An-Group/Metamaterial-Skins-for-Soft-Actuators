...
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['P'].faces.findAt(((84.168503, 
    101.412778, 0.666667), ), ((76.576322, 101.412778, 1.333333), ), ((
    68.460541, 101.412778, 1.333333), ), ((60.34476, 101.412778, 1.333333), ), 
    ((52.228977, 101.412778, 1.333333), ), ((92.284286, 101.412778, 0.666667), 
    ), ), name='Set-t')
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['P'].faces.findAt(((92.807884, 
    -2.897222, 0.666667), ), ((84.692101, -2.897222, 0.666667), ), ((76.576322, 
    -2.897222, 0.666667), ), ((68.460541, -2.897222, 0.666667), ), ((59.821161, 
    -2.897222, 1.333333), ), ((52.228977, -2.897222, 0.666667), ), ), name=
    'Set-bc')
mdb.models['Model-1'].rootAssembly.regenerate()
mdb.models['Model-1'].Equation(name='Constraint-1', terms=((1.0, 'Set-t', 2), (
    -1.0, 'Part-3-1.Set-1', 2)))
...
# # Job
jobName = 'nv_9_4-MU37' +Parameters
###############################################
