...
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['N'].faces.findAt(((35.473817, 
    101.412778, 0.666667), ), ((27.881634, 101.412778, 1.333333), ), ((
    19.765855, 101.412778, 1.333333), ), ((11.650073, 101.412778, 1.333333), ), 
    ((3.534292, 101.412778, 1.333333), ), ((43.589597, 101.412778, 0.666667), 
    ), ), name='Set-t')
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['N'].faces.findAt(((44.113196, 
    -2.897222, 0.666667), ), ((35.997416, -2.897222, 0.666667), ), ((27.881634, 
    -2.897222, 0.666667), ), ((19.765855, -2.897222, 0.666667), ), ((11.126474, 
    -2.897222, 1.333333), ), ((3.534292, -2.897222, 0.666667), ), ), name=
    'Set-bc')
mdb.models['Model-1'].rootAssembly.regenerate()
...
# # Job
jobName = 'nv_9_3-MU37' +Parameters
###############################################
