...
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='N_g_3', part=
    mdb.models['Model-1'].parts['N_g_3'])
...
# SectionAssignment
mdb.models['Model-1'].parts['N_g_3'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['N_g_3'].sets['Set-N'], sectionName=
...
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['N_g_3'].faces.findAt(((
    47.909288, 1.741667, 1.333333), ), ((47.909288, 20.608334, 0.666667), ), ((
    47.909288, 31.541667, 1.333333), ), ((47.909288, 50.408333, 0.666667), ), (
    (47.909288, 61.341667, 1.333333), ), ((47.909288, 76.241669, 1.333333), ), 
    ((47.909288, 95.108332, 0.666667), ), ), name='Set-r')
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['N_g_3'].faces.findAt(((
    -0.785398, 1.741667, 0.666667), ), ((-0.785398, 95.108332, 1.333333), ), ((
    -0.785398, 16.641667, 0.666667), ), ((-0.785398, 31.541667, 0.666667), ), (
    (-0.785398, 46.441666, 0.666667), ), ((-0.785398, 61.341667, 0.666667), ), 
    ((-0.785398, 76.241669, 0.666667), ), ), name='Set-bc')
mdb.models['Model-1'].rootAssembly.regenerate()
...
# mesh
mdb.models['Model-1'].parts['N_g_3'].setMeshControls(elemShape=TET, regions=
    mdb.models['Model-1'].parts['N_g_3'].cells, technique=FREE)
mdb.models['Model-1'].parts['N_g_3'].setElementType(elemTypes=(ElemType(
    ...
    regions=(mdb.models['Model-1'].parts['N_g_3'].cells, ))
mdb.models['Model-1'].parts['N_g_3'].seedPart(deviationFactor=0.1, 
    minSizeFactor=0.1, size=1.0)
mdb.models['Model-1'].parts['N_g_3'].generateMesh()
...
mdb.models['Model-1'].rootAssembly.Set(name='Set-y', vertices=
    mdb.models['Model-1'].rootAssembly.instances['N_g_3'].vertices.findAt(((
    26.834437, 100.575, 2.0), )))
