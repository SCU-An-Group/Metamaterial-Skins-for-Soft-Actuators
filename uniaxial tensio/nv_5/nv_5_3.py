...
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['N'].faces.findAt(((3.534292, 
    99.085, 1.333333), ), ((11.126474, 99.085, 0.666667), ), ((19.242256, 
    99.085, 0.666667), ), ((27.358035, 99.085, 0.666667), ), ((35.473817, 
    99.085, 0.666667), ), ((44.113196, 99.085, 1.333333), ), ), name='Set-t')
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['N'].faces.findAt(((19.765855, 
    -5.215, 0.666667), ), ((27.358035, -5.215, 1.333333), ), ((35.473817, 
    -5.215, 1.333333), ), ((43.589597, -5.215, 1.333333), ), ((3.010693, 
    -5.215, 1.333333), ), ((11.126474, -5.215, 1.333333), ), ), name='Set-bc')
mdb.models['Model-1'].rootAssembly.regenerate()
...
# # Job
jobName = 'nv_5_3-MU37' +Parameters
###############################################
