...
mdb.models['Model-1'].rootAssembly.Set(faces=
    ...
    3.010693, 100.575, 0.666667), ), ((43.589597, 100.575, 0.666667), ), ((
    35.997416, 100.575, 1.333333), ), ((27.881634, 100.575, 1.333333), ), ((
    19.765855, 100.575, 1.333333), ), ((11.650073, 100.575, 1.333333), ), ), 
    name='Set-t')
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['N_g_3'].faces.findAt(((
    44.113196, -3.725, 0.666667), ), ((35.997416, -3.725, 0.666667), ), ((
    27.881634, -3.725, 0.666667), ), ((19.765855, -3.725, 0.666667), ), ((
    11.650073, -3.725, 0.666667), ), ((3.534292, -3.725, 0.666667), ), ), name=
    'Set-bc')
mdb.models['Model-1'].rootAssembly.regenerate()
