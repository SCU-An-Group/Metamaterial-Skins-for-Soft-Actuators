...
# import part
mdb.openAcis('E:/abaqus cube/revised_1/NPR_PPR/PN012.SAT', scaleFromFile=ON)
mdb.models['Model-1'].PartFromGeometryFile(combine=False, dimensionality=
    THREE_D, geometryFile=mdb.acis, name='PN012-1', type=DEFORMABLE_BODY)
mdb.models['Model-1'].PartFromGeometryFile(bodyNum=2, combine=False, 
    dimensionality=THREE_D, geometryFile=mdb.acis, name='PN012-2', type=
    DEFORMABLE_BODY)
mdb.models['Model-1'].PartFromGeometryFile(bodyNum=3, combine=False, 
    dimensionality=THREE_D, geometryFile=mdb.acis, name='PN012-3', type=
    DEFORMABLE_BODY)


# creat set
mdb.models['Model-1'].parts['PN012-1'].Set(cells=
    mdb.models['Model-1'].parts['PN012-1'].cells, name='Set-ex')
mdb.models['Model-1'].parts['PN012-2'].Set(cells=
    mdb.models['Model-1'].parts['PN012-2'].cells, name='Set-tube')
mdb.models['Model-1'].parts['PN012-3'].Set(cells=
    mdb.models['Model-1'].parts['PN012-3'].cells, name='Set-cover')
...
# SectionAssignment
mdb.models['Model-1'].parts['PN012-1'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['PN012-1'].sets['Set-ex'], sectionName=
    'Section-ex', thicknessAssignment=FROM_SECTION)
mdb.models['Model-1'].parts['PN012-2'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['PN012-2'].sets['Set-tube'], sectionName=
    'Section-tube', thicknessAssignment=FROM_SECTION)
mdb.models['Model-1'].parts['PN012-3'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['PN012-3'].sets['Set-cover'], sectionName=
    'Section-cover', thicknessAssignment=FROM_SECTION)


# assembly
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='PN012-1-1', 
    part=mdb.models['Model-1'].parts['PN012-1'])
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='PN012-2-1', 
    part=mdb.models['Model-1'].parts['PN012-2'])
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='PN012-3-1', 
    part=mdb.models['Model-1'].parts['PN012-3'])
# merge
mdb.models['Model-1'].rootAssembly.InstanceFromBooleanMerge(domain=GEOMETRY, 
    instances=(mdb.models['Model-1'].rootAssembly.instances['PN012-2-1'], 
    mdb.models['Model-1'].rootAssembly.instances['PN012-3-1']), 
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-ex', side1Faces=
    mdb.models['Model-1'].rootAssembly.instances['PN012-1-1'].faces.findAt(((
    9.49464, 12.416667, 12.984189), ), ((9.064013, 94.366666, 16.744874), ), ))
...
mdb.models['Model-1'].parts['PN012-1'].setMeshControls(elemShape=TET, regions=
    mdb.models['Model-1'].parts['PN012-1'].cells, technique=FREE)
mdb.models['Model-1'].parts['PN012-1'].setElementType(elemTypes=(ElemType(
    elemCode=C3D10H, elemLibrary=STANDARD), ElemType(elemCode=C3D10H, 
    elemLibrary=STANDARD), ElemType(elemCode=C3D10H, elemLibrary=STANDARD)), 
    regions=(mdb.models['Model-1'].parts['PN012-1'].cells, ))
mdb.models['Model-1'].parts['PN012-1'].seedPart(deviationFactor=0.1, 
    minSizeFactor=0.1, size=1.0)
mdb.models['Model-1'].parts['PN012-1'].generateMesh()
