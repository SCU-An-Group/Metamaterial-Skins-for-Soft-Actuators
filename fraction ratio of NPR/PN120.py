...
# import part
mdb.openAcis('/public23/home/sca3828/pyc/PPR_NPR/PN120.SAT', scaleFromFile=ON)
mdb.models['Model-1'].PartFromGeometryFile(combine=False, dimensionality=
    THREE_D, geometryFile=mdb.acis, name='PN120-1', type=DEFORMABLE_BODY)
mdb.models['Model-1'].PartFromGeometryFile(bodyNum=2, combine=False, 
    dimensionality=THREE_D, geometryFile=mdb.acis, name='PN120-2', type=
    DEFORMABLE_BODY)
mdb.models['Model-1'].PartFromGeometryFile(bodyNum=3, combine=False, 
    dimensionality=THREE_D, geometryFile=mdb.acis, name='PN120-3', type=
    DEFORMABLE_BODY)


# creat set
mdb.models['Model-1'].parts['PN120-1'].Set(cells=
    mdb.models['Model-1'].parts['PN120-1'].cells, name='Set-ex')
mdb.models['Model-1'].parts['PN120-2'].Set(cells=
    mdb.models['Model-1'].parts['PN120-2'].cells, name='Set-tube')
mdb.models['Model-1'].parts['PN120-3'].Set(cells=
    mdb.models['Model-1'].parts['PN120-3'].cells, name='Set-cover')
...
# SectionAssignment
mdb.models['Model-1'].parts['PN120-1'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['PN120-1'].sets['Set-ex'], sectionName=
    'Section-ex', thicknessAssignment=FROM_SECTION)
mdb.models['Model-1'].parts['PN120-2'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['PN120-2'].sets['Set-tube'], sectionName=
    'Section-tube', thicknessAssignment=FROM_SECTION)
mdb.models['Model-1'].parts['PN120-3'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['PN120-3'].sets['Set-cover'], sectionName=
    'Section-cover', thicknessAssignment=FROM_SECTION)


# assembly
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='PN120-1-1', 
    part=mdb.models['Model-1'].parts['PN120-1'])
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='PN120-2-1', 
    part=mdb.models['Model-1'].parts['PN120-2'])
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='PN120-3-1', 
    part=mdb.models['Model-1'].parts['PN120-3'])
# merge
mdb.models['Model-1'].rootAssembly.InstanceFromBooleanMerge(domain=GEOMETRY, 
    instances=(mdb.models['Model-1'].rootAssembly.instances['PN120-2-1'], 
    mdb.models['Model-1'].rootAssembly.instances['PN120-3-1']), 
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-ex', side1Faces=
    mdb.models['Model-1'].rootAssembly.instances['PN120-1-1'].faces.findAt(((
    11.256615, 2.483333, 8.830002), ), ((9.117038, 89.400002, 17.762803), ), ))
...
mdb.models['Model-1'].rootAssembly.Set(faces=
    ...
    18.872345, -3.725, 1.379245), ), ((28.251545, -3.725, 1.379245), ), ((
    33.848727, -3.725, 5.357608), ), ((38.041756, -3.725, 11.993797), ), ((
    39.001705, -3.725, 19.999065), ), ((35.183634, -3.725, 27.250158), ), ((
    26.899364, -3.725, 31.292985), ), ((20.224525, -3.725, 31.292985), ), ((
...
mdb.models['Model-1'].rootAssembly.Set(edges=
    ...
    23.561945, 73.0, 2.0), )), name='Set-testline_in')

mdb.models['Model-1'].rootAssembly.Set(edges=
    mdb.models['Model-1'].rootAssembly.instances['Part-tube-1'].edges.findAt(((
    23.561945, 73.0, 31.0), )), name='Set-testline_out')
...
mdb.models['Model-1'].parts['PN120-1'].setMeshControls(elemShape=TET, regions=
    mdb.models['Model-1'].parts['PN120-1'].cells, technique=FREE)
mdb.models['Model-1'].parts['PN120-1'].setElementType(elemTypes=(ElemType(
    elemCode=C3D10H, elemLibrary=STANDARD), ElemType(elemCode=C3D10H, 
    elemLibrary=STANDARD), ElemType(elemCode=C3D10H, elemLibrary=STANDARD)), 
    regions=(mdb.models['Model-1'].parts['PN120-1'].cells, ))
mdb.models['Model-1'].parts['PN120-1'].seedPart(deviationFactor=0.1, 
    minSizeFactor=0.1, size=1.0)
mdb.models['Model-1'].parts['PN120-1'].generateMesh()
