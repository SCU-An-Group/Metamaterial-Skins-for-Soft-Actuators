...
# import part
mdb.openAcis('/public23/home/sca3828/pyc/PPR_NPR/PN84.SAT', scaleFromFile=ON)
...
# rotate
mdb.models['Model-1'].rootAssembly.rotate(angle=30.0, axisDirection=(0.0, 
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-ex', side1Faces=
    ...
    34.211011, 99.333331, 26.341107), ), ((37.841491, 81.949999, 19.018843), ), 
    ))
...
mdb.models['Model-1'].rootAssembly.Set(faces=
    ...
    mdb.models['Model-1'].rootAssembly.instances['Part-ex-1'].faces.findAt(((
    35.183636, -3.725, 27.250158), ), ((28.251544, -3.725, 31.620755), ), ((
    20.06288, -3.725, 31.939759), ), ((11.940254, -3.725, 27.250159), ), ((
    8.122186, -3.725, 19.999065), ), ((8.76896, -3.725, 13.162581), ), ((
    13.275163, -3.725, 5.357608), ), ((20.224526, -3.725, 1.707014), ), ((
    27.06101, -3.725, 1.060242), ), ((35.183635, -3.725, 5.749842), ), ((
    38.041755, -3.725, 11.993796), ), ((38.354931, -3.725, 19.837419), ), ), 
    name='Set-BC')
...
mdb.models['Model-1'].parts['Part-ex'].PartitionCellByPlaneThreePoints(cells=
    ...
    21.391149), )), point1=
    mdb.models['Model-1'].parts['Part-ex'].vertices.findAt((16.311945, 99.075, 
    29.057368), ), point2=
    mdb.models['Model-1'].parts['Part-ex'].vertices.findAt((15.311945, 99.075, 
    30.789419), ), point3=
    mdb.models['Model-1'].parts['Part-ex'].vertices.findAt((15.311945, 87.175, 
    30.789419), ))
mdb.models['Model-1'].rootAssembly.regenerate()
mdb.models['Model-1'].rootAssembly.Set(cells=
    mdb.models['Model-1'].rootAssembly.instances['Part-ex-1'].cells.findAt(((
    20.65837, 5.94377, 31.311436), )), name='Set-7', referencePoints=(
    mdb.models['Model-1'].rootAssembly.referencePoints[22], ))
mdb.models['Model-1'].rootAssembly.Set(cells=
    mdb.models['Model-1'].rootAssembly.instances['Part-ex-1'].cells.findAt(((
    8.622455, 83.45623, 18.649662), )), name='Set-8')
