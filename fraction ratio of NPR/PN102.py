...
# import part
mdb.openAcis('/public23/home/sca3828/pyc/PPR_NPR/PN102.SAT', scaleFromFile=ON)
...
# rotate
mdb.models['Model-1'].rootAssembly.rotate(angle=60.0, axisDirection=(0.0, 
    -104.3, 0.0), axisPoint=(23.561945, 100.575, 16.5), instanceList=(
    'Part-ex-1', ))
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-ex', side1Faces=
    ...
    27.863754, 99.333331, 30.347182), ), ((34.668973, 81.949999, 25.821155), ), 
    ))
...
mdb.models['Model-1'].rootAssembly.Set(faces=
    ...
    mdb.models['Model-1'].rootAssembly.instances['Part-ex-1'].faces.findAt(((
    26.899364, -3.725, 31.292985), ), ((20.06288, -3.725, 31.939757), ), ((
    12.419553, -3.725, 26.786782), ), ((8.122186, -3.725, 19.999065), ), ((
    8.441189, -3.725, 11.810399), ), ((12.419554, -3.725, 6.213217), ), ((
    20.224526, -3.725, 1.707014), ), ((28.068148, -3.725, 2.020189), ), ((
    34.312103, -3.725, 4.87831), ), ((39.001703, -3.725, 13.000935), ), ((
    38.35493, -3.725, 19.837418), ), ((34.704337, -3.725, 26.786782), ), ), 
    name='Set-BC')
...
mdb.models['Model-1'].parts['Part-ex'].PartitionCellByPlaneThreePoints(cells=
    mdb.models['Model-1'].parts['Part-ex'].cells.findAt(((9.283077, 6.73123, 
    21.391149), )), point1=
    mdb.models['Model-1'].parts['Part-ex'].vertices.findAt((30.811945, 99.075, 
    29.057368), ), point2=
    mdb.models['Model-1'].parts['Part-ex'].vertices.findAt((31.811945, 99.075, 
    30.789419), ), point3=
    mdb.models['Model-1'].parts['Part-ex'].vertices.findAt((31.811945, 87.175, 
    30.789419), ))
mdb.models['Model-1'].rootAssembly.regenerate()
mdb.models['Model-1'].rootAssembly.Set(cells=
    mdb.models['Model-1'].rootAssembly.instances['Part-ex-1'].cells.findAt(((
    22.76, 2.483333, 32.313011), )), name='Set-7', referencePoints=(
    mdb.models['Model-1'].rootAssembly.referencePoints[21], ))
mdb.models['Model-1'].rootAssembly.Set(cells=
    mdb.models['Model-1'].rootAssembly.instances['Part-ex-1'].cells.findAt(((
    8.622454, 83.456231, 18.649663), )), name='Set-8')
