...
# import part
mdb.openAcis('/public23/home/sca3828/pyc/PPR_NPR/PN93.SAT', scaleFromFile=ON)
...
mdb.models['Model-1'].parts['Part-ex'].PartitionCellByPlaneThreePoints(cells=
    mdb.models['Model-1'].parts['Part-ex'].cells.findAt(((9.687879, 1.50623, 
    22.443038), )), point1=
    mdb.models['Model-1'].parts['Part-ex'].vertices.findAt((23.56083, 
    99.075811, 31.0), ), point2=
    mdb.models['Model-1'].parts['Part-ex'].vertices.findAt((23.560676, 
    99.07581, 33.0), ), point3=
    mdb.models['Model-1'].parts['Part-ex'].vertices.findAt((23.560676, 
    87.174189, 33.0), ))
mdb.models['Model-1'].rootAssembly.regenerate()
mdb.models['Model-1'].rootAssembly.Set(cells=
    mdb.models['Model-1'].rootAssembly.instances['Part-ex-1'].cells.findAt(((
    16.923825, 5.94377, 30.055248), )), name='Set-7', referencePoints=(
    mdb.models['Model-1'].rootAssembly.referencePoints[22], ))
mdb.models['Model-1'].rootAssembly.Set(cells=
    mdb.models['Model-1'].rootAssembly.instances['Part-ex-1'].cells.findAt(((
    9.669593, 83.45623, 22.400166), )), name='Set-8')
