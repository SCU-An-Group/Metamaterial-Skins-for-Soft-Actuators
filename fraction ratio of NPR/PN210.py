...
# import part
mdb.openAcis('/public23/home/sca3828/pyc/PPR_NPR/PN210.SAT', scaleFromFile=ON)
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-ex', side1Faces=
    ...
    12.454917, 81.208331, 7.178845), ), ((35.995086, 91.883334, 23.961033), ), 
    ))
...
mdb.models['Model-1'].rootAssembly.Set(faces=
    ...
    12.419553, -3.725, 26.786782), ), ((9.082134, -3.725, 21.006203), ), ((
    8.441189, -3.725, 11.810399), ), ((12.811787, -3.725, 4.878309), ), ((
    20.224526, -3.725, 1.707014), ), ((28.068148, -3.725, 2.020189), ), ((
    34.704337, -3.725, 6.213217), ), ((39.001703, -3.725, 13.000935), ), ((
    38.6827, -3.725, 21.189599), ), ((34.704337, -3.725, 26.786782), ), ), 
    name='Set-BC')
...
mdb.models['Model-1'].parts['Part-ex'].PartitionCellByPlaneThreePoints(cells=
    mdb.models['Model-1'].parts['Part-ex'].cells.findAt(((8.495308, 98.091665, 
    21.367328), )), point1=
