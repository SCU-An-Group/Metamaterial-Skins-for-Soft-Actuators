...
# import part
mdb.openAcis('/public23/home/sca3828/pyc/PPR_NPR/PN48.SAT', scaleFromFile=ON)
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-ex', side1Faces=
    ...
    9.282399, 81.208331, 13.981157), ), ((38.059877, 91.883334, 16.744874), ), 
    ))
...
mdb.models['Model-1'].rootAssembly.Set(faces=
    ...
    mdb.models['Model-1'].rootAssembly.instances['Part-ex-1'].faces.findAt(((
    33.848728, -3.725, 27.642391), ), ((28.251544, -3.725, 31.620755), ), ((
    20.06288, -3.725, 31.939759), ), ((13.275162, -3.725, 27.642391), ), ((
    8.122186, -3.725, 19.999065), ), ((8.441189, -3.725, 11.8104), ), ((
    13.275163, -3.725, 5.357608), ), ((20.224526, -3.725, 1.707014), ), ((
    28.068148, -3.725, 2.020189), ), ((35.183635, -3.725, 5.749842), ), ((
    39.001702, -3.725, 13.000935), ), ((38.354931, -3.725, 19.837419), ), ), 
    name='Set-BC')
...
mdb.models['Model-1'].parts['Part-ex'].PartitionCellByPlaneThreePoints(cells=
    mdb.models['Model-1'].parts['Part-ex'].cells.findAt(((8.090377, 95.387339, 
    19.466619), )), point1=
...
mdb.models['Model-1'].rootAssembly.Set(cells=
    ...
    22.793766, 92.625, 31.6472), )), name='Set-4', referencePoints=(
    mdb.models['Model-1'].rootAssembly.referencePoints[21], ))
mdb.models['Model-1'].rootAssembly.Set(cells=
    mdb.models['Model-1'].rootAssembly.instances['Part-ex-1'].cells.findAt(((
    8.414744, 91.883334, 15.731821), )), name='Set-5')
