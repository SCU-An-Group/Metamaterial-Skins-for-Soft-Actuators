...
# import part
mdb.openAcis('E:/abaqus cube/3D/parameters/step/nv_9_1.SAT', scaleFromFile=ON)
mdb.models['Model-1'].PartFromGeometryFile(combine=False, dimensionality=
    THREE_D, geometryFile=mdb.acis, name='nv_9-1', type=DEFORMABLE_BODY)
mdb.models['Model-1'].PartFromGeometryFile(bodyNum=2, combine=False, 
    dimensionality=THREE_D, geometryFile=mdb.acis, name='nv_9-2', type=
    DEFORMABLE_BODY)
mdb.models['Model-1'].PartFromGeometryFile(bodyNum=3, combine=False, 
    dimensionality=THREE_D, geometryFile=mdb.acis, name='nv_9-3', type=
    DEFORMABLE_BODY)
...
# creat set
mdb.models['Model-1'].parts['nv_9-1'].Set(cells=
    mdb.models['Model-1'].parts['nv_9-1'].cells, name='Set-ex')
mdb.models['Model-1'].parts['nv_9-2'].Set(cells=
    mdb.models['Model-1'].parts['nv_9-2'].cells, name='Set-tube')
mdb.models['Model-1'].parts['nv_9-3'].Set(cells=
    mdb.models['Model-1'].parts['nv_9-3'].cells, name='Set-cover')
...
# SectionAssignment
mdb.models['Model-1'].parts['nv_9-1'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['nv_9-1'].sets['Set-ex'], sectionName=
    'Section-ex', thicknessAssignment=FROM_SECTION)
mdb.models['Model-1'].parts['nv_9-2'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['nv_9-2'].sets['Set-tube'], sectionName=
    'Section-tube', thicknessAssignment=FROM_SECTION)
mdb.models['Model-1'].parts['nv_9-3'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['nv_9-3'].sets['Set-cover'], sectionName=
    'Section-cover', thicknessAssignment=FROM_SECTION)



# assembly
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='nv_9-1-1', 
    part=mdb.models['Model-1'].parts['nv_9-1'])
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='nv_9-2-1', 
    part=mdb.models['Model-1'].parts['nv_9-2'])
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='nv_9-3-1', 
    part=mdb.models['Model-1'].parts['nv_9-3'])
# merge
mdb.models['Model-1'].rootAssembly.InstanceFromBooleanMerge(domain=GEOMETRY, 
    instances=(mdb.models['Model-1'].rootAssembly.instances['nv_9-2-1'], 
    mdb.models['Model-1'].rootAssembly.instances['nv_9-3-1']), 
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-tube', side1Faces=
    ...
    25.072042, 65.302778, 2.078849), ), ((22.051848, 65.302778, 30.921151), ), 
    ))
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-ex', side1Faces=
    mdb.models['Model-1'].rootAssembly.instances['nv_9-1-1'].faces.findAt(((
    37.62925, 9.078704, 20.015811), ), ((38.059877, 92.140556, 16.255126), ), 
    ))
...
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['Part-tube-1'].faces.findAt(((
    10.45815, -2.897222, 19.340962), ), )+\
    mdb.models['Model-1'].rootAssembly.instances['nv_9-1-1'].faces.findAt(((
    38.041756, -2.897222, 21.006203), ), ((35.183634, -2.897222, 27.250158), ), 
    ((26.899364, -2.897222, 31.292985), ), ((18.872345, -2.897222, 31.620756), 
    ), ((11.940254, -2.897222, 27.250158), ), ((8.122186, -2.897222, 
    19.999065), ), ((9.082134, -2.897222, 11.993797), ), ((11.940254, 
    -2.897222, 5.749842), ), ((20.224525, -2.897222, 1.707014), ), ((28.251545, 
    -2.897222, 1.379245), ), ((35.183634, -2.897222, 5.749842), ), ((39.001705, 
    -2.897222, 13.000936), ), ), name='Set-BC')
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-cavity', side1Faces=
    mdb.models['Model-1'].rootAssembly.instances['Part-tube-1'].faces.findAt(((
    11.746775, 99.402778, 18.583334), ), ((22.11737, 65.969445, 4.083752), ), (
    (25.00652, 65.969445, 28.916248), ), ((11.746775, -0.897222, 14.416667), ), 
    ))
# fluid property
...
mdb.models['Model-1'].rootAssembly.Set(edges=
    ...
    23.561945, 73.827778, 31.0), )), name='Set-testline_in')

mdb.models['Model-1'].rootAssembly.Set(edges=
    mdb.models['Model-1'].rootAssembly.instances['Part-tube-1'].edges.findAt(((
    23.561945, 73.827778, 2.0), )), name='Set-testline_out')
...
RP_2 = mdb.models['Model-1'].rootAssembly.ReferencePoint(point=
    ...
    mdb.models['Model-1'].rootAssembly.instances['Part-tube-1'].edges.findAt((
    23.561945, 73.827778, 31.0), ), MIDDLE))
RP_3 = mdb.models['Model-1'].rootAssembly.ReferencePoint(point=
    mdb.models['Model-1'].rootAssembly.instances['Part-tube-1'].InterestingPoint(
    mdb.models['Model-1'].rootAssembly.instances['Part-tube-1'].edges.findAt((
    23.561945, 73.827778, 2.0), ), MIDDLE))
...
mdb.models['Model-1'].parts['Part-tube'].setMeshControls(elemShape=TET, 
    ...
    -2.897222, 19.340962), ), ((9.35146, 101.402778, 15.006418), ), ), 
    technique=FREE)
...
mdb.models['Model-1'].parts['nv_9-1'].setMeshControls(elemShape=TET, regions=
    mdb.models['Model-1'].parts['nv_9-1'].cells.findAt(((37.62925, 9.078704, 
    20.015811), )), technique=FREE)
mdb.models['Model-1'].parts['nv_9-1'].setElementType(elemTypes=(ElemType(
    elemCode=C3D10H, elemLibrary=STANDARD), ElemType(elemCode=C3D10H, 
    elemLibrary=STANDARD), ElemType(elemCode=C3D10H, elemLibrary=STANDARD)), 
    regions=(mdb.models['Model-1'].parts['nv_9-1'].cells.findAt(((37.62925, 
    9.078704, 20.015811), )), ))
mdb.models['Model-1'].parts['nv_9-1'].setElementType(elemTypes=(ElemType(
    elemCode=C3D10H, elemLibrary=STANDARD), ElemType(elemCode=C3D10H, 
    elemLibrary=STANDARD), ElemType(elemCode=C3D10H, elemLibrary=STANDARD)), 
    regions=(mdb.models['Model-1'].parts['nv_9-1'].cells.findAt(((37.62925, 
    9.078704, 20.015811), )), ))
mdb.models['Model-1'].parts['nv_9-1'].seedPart(deviationFactor=0.1, 
    minSizeFactor=0.1, size=1.0)
mdb.models['Model-1'].parts['nv_9-1'].generateMesh()
