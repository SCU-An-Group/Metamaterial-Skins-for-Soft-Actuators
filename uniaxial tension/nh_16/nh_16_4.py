...
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['P'].faces.findAt(((51.214507, 
    100.575, 1.333333), ), ((56.777742, 100.575, 0.666667), ), ((62.864578, 
    100.575, 0.666667), ), ((68.951416, 100.575, 0.666667), ), ((75.038249, 
    100.575, 0.666667), ), ((81.125084, 100.575, 0.666667), ), ((87.211922, 
    100.575, 0.666667), ), ((93.298759, 100.575, 0.666667), ), ), name='Set-t')
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['P'].faces.findAt(((51.214507, 
    -3.725, 0.666667), ), ((56.777742, -3.725, 1.333333), ), ((62.864578, 
    -3.725, 1.333333), ), ((68.951416, -3.725, 1.333333), ), ((75.038249, 
    -3.725, 1.333333), ), ((81.125084, -3.725, 1.333333), ), ((87.211922, 
    -3.725, 1.333333), ), ((93.298759, -3.725, 1.333333), ), ), name='Set-bc')
mdb.models['Model-1'].rootAssembly.regenerate()
...
# # Job
jobName = 'nh_16_4-MU37' +Parameters
###############################################
