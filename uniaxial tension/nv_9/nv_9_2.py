...
mdb.openAcis('F:/abaqus tube/express/nv_9/N_nv_9_1.SAT', scaleFromFile=ON)
mdb.models['Model-1'].PartFromGeometryFile(combine=False, dimensionality=
    THREE_D, geometryFile=mdb.acis, name='N', type=DEFORMABLE_BODY)
mdb.models['Model-1'].PartFromGeometryFile(bodyNum=2, combine=False, 
    dimensionality=THREE_D, geometryFile=mdb.acis, name='P', type=
    DEFORMABLE_BODY)



mdb.models['Model-1'].rootAssembly.DatumCsysByDefault(CARTESIAN)
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='P', part=
    mdb.models['Model-1'].parts['P'])



# creat set
mdb.models['Model-1'].parts['N'].Set(cells=
    mdb.models['Model-1'].parts['N'].cells, name='Set-N')
mdb.models['Model-1'].parts['P'].Set(cells=
    mdb.models['Model-1'].parts['P'].cells, name='Set-P')
...
# SectionAssignment
mdb.models['Model-1'].parts['N'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['N'].sets['Set-N'], sectionName=
    'Section-ex', thicknessAssignment=FROM_SECTION)
mdb.models['Model-1'].parts['P'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['P'].sets['Set-P'], sectionName=
    'Section-ex', thicknessAssignment=FROM_SECTION)
...
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['P'].faces.findAt(((96.603974, 
    1.931852, 1.333333), ), ((96.603974, 84.993701, 0.666667), ), ((96.603974, 
    94.651853, 1.333333), ), ((96.603974, 73.403704, 0.666667), ), ((96.603974, 
    15.453704, 0.666667), ), ((96.603974, 25.111852, 1.333333), ), ((96.603974, 
    36.701852, 1.333333), ), ((96.603974, 50.223704, 0.666667), ), ((96.603974, 
    59.881852, 1.333333), ), ), name='Set-r')
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['P'].faces.findAt(((47.909288, 
    1.931852, 0.666667), ), ((47.909288, 96.583705, 1.333333), ), ((47.909288, 
    84.993701, 1.333333), ), ((47.909288, 73.403704, 1.333333), ), ((47.909288, 
    13.521852, 0.666667), ), ((47.909288, 25.111852, 0.666667), ), ((47.909288, 
    36.701852, 0.666667), ), ((47.909288, 48.291852, 0.666667), ), ((47.909288, 
    59.881852, 0.666667), ), ), name='Set-bc')
mdb.models['Model-1'].rootAssembly.regenerate()
mdb.models['Model-1'].Equation(name='Constraint-1', terms=((1.0, 'Set-r', 1), (
...
mdb.models['Model-1'].DisplacementBC(amplitude=UNSET, createStepName='Step-1', 
    ...
    20.0, u2=UNSET, u3=UNSET, ur1=UNSET, ur2=UNSET, ur3=UNSET)



# mesh
mdb.models['Model-1'].parts['P'].setMeshControls(elemShape=TET, regions=
    mdb.models['Model-1'].parts['P'].cells, technique=FREE)
mdb.models['Model-1'].parts['P'].setElementType(elemTypes=(ElemType(
    ...
    regions=(mdb.models['Model-1'].parts['P'].cells, ))
mdb.models['Model-1'].parts['P'].seedPart(deviationFactor=0.1, 
    minSizeFactor=0.1, size=1.0)
mdb.models['Model-1'].parts['P'].generateMesh()
...
mdb.models['Model-1'].rootAssembly.Set(name='Set-y', vertices=
    mdb.models['Model-1'].rootAssembly.instances['P'].vertices.findAt(((
    75.529123, 101.412778, 2.0), )))
mdb.models['Model-1'].rootAssembly.Set(name='Set-x', vertices=
    mdb.models['Model-1'].rootAssembly.instances['P'].vertices.findAt(((
    96.603974, 52.155556, 2.0), )))
...
# # Job
jobName = 'nv_9_2-MU37' +Parameters
###############################################
