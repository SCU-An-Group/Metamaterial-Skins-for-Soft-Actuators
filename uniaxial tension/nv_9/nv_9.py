...
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='N', part=
    mdb.models['Model-1'].parts['N'])
...
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['N'].faces.findAt(((47.909288, 
    1.352407, 1.333333), ), ((47.909288, 85.573148, 0.666667), ), ((47.909288, 
    94.072408, 1.333333), ), ((47.909288, 73.983149, 0.666667), ), ((47.909288, 
    16.033147, 0.666667), ), ((47.909288, 24.532408, 1.333333), ), ((47.909288, 
    36.122407, 1.333333), ), ((47.909288, 50.803149, 0.666667), ), ((47.909288, 
    59.302406, 1.333333), ), ), name='Set-r')
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['N'].faces.findAt(((-0.785398, 
    1.352407, 0.666667), ), ((-0.785398, 97.16315, 1.333333), ), ((-0.785398, 
    85.573148, 1.333333), ), ((-0.785398, 73.983149, 1.333333), ), ((-0.785398, 
    12.942407, 0.666667), ), ((-0.785398, 24.532408, 0.666667), ), ((-0.785398, 
    36.122407, 0.666667), ), ((-0.785398, 47.712407, 0.666667), ), ((-0.785398, 
    59.302406, 0.666667), ), ), name='Set-bc')
mdb.models['Model-1'].rootAssembly.regenerate()
...
# mesh
mdb.models['Model-1'].parts['N'].setMeshControls(elemShape=TET, regions=
    mdb.models['Model-1'].parts['N'].cells, technique=FREE)
mdb.models['Model-1'].parts['N'].setElementType(elemTypes=(ElemType(
    ...
    regions=(mdb.models['Model-1'].parts['N'].cells, ))
mdb.models['Model-1'].parts['N'].seedPart(deviationFactor=0.1, 
    minSizeFactor=0.1, size=1.0)
mdb.models['Model-1'].parts['N'].generateMesh()
...
mdb.models['Model-1'].rootAssembly.Set(name='Set-y', vertices=
    mdb.models['Model-1'].rootAssembly.instances['N'].vertices.findAt(((
    26.834437, 101.412778, 2.0), )))
mdb.models['Model-1'].rootAssembly.Set(name='Set-x', vertices=
    mdb.models['Model-1'].rootAssembly.instances['N'].vertices.findAt(((
    47.909288, 53.893889, 2.0), )))
