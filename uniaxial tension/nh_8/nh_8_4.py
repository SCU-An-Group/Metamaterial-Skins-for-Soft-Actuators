...
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['P'].faces.findAt(((-6.610435, 
    100.575, 1.333333), ), ((-18.784107, 100.575, 1.333333), ), ((-30.957778, 
    100.575, 1.333333), ), ((-43.131448, 100.575, 1.333333), ), ), name=
    'Set-u')
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['P'].faces.findAt(((
    -43.655047, -3.725, 1.333333), ), ((-31.481376, -3.725, 1.333333), ), ((
    -19.307706, -3.725, 1.333333), ), ((-7.134033, -3.725, 1.333333), ), ), 
    name='Set-bc')
mdb.models['Model-1'].rootAssembly.regenerate()
mdb.models['Model-1'].Equation(name='Constraint-1', terms=((1.0, 'Set-u', 1), (
...
# # Job
jobName = 'nh_8_4-MU37' +Parameters
###############################################
