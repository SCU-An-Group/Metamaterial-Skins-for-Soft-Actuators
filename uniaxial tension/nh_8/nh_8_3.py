...
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['N'].faces.findAt(((42.08425, 
    100.575, 1.333333), ), ((29.91058, 100.575, 1.333333), ), ((17.736909, 
    100.575, 1.333333), ), ((5.563237, 100.575, 1.333333), ), ), name='Set-u')
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['N'].faces.findAt(((5.039638, 
    -3.725, 1.333333), ), ((42.08425, -3.725, 0.666667), ), ((29.91058, -3.725, 
    0.666667), ), ((17.736909, -3.725, 0.666667), ), ), name='Set-bc')
mdb.models['Model-1'].rootAssembly.regenerate()
mdb.models['Model-1'].Equation(name='Constraint-1', terms=((1.0, 'Set-u', 2), (
...
# # Job
jobName = 'nh_8_3-MU37' +Parameters
###############################################
