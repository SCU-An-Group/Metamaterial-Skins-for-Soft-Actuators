...
# import part
mdb.openAcis('E:/abaqus cube/3D/parameters/step/nh_16_1.SAT', scaleFromFile=ON)
mdb.models['Model-1'].PartFromGeometryFile(combine=False, dimensionality=
    THREE_D, geometryFile=mdb.acis, name='nh_16-1', type=DEFORMABLE_BODY)
mdb.models['Model-1'].PartFromGeometryFile(bodyNum=2, combine=False, 
    dimensionality=THREE_D, geometryFile=mdb.acis, name='nh_16-2', type=
    DEFORMABLE_BODY)
mdb.models['Model-1'].PartFromGeometryFile(bodyNum=3, combine=False, 
    dimensionality=THREE_D, geometryFile=mdb.acis, name='nh_16-3', type=
    DEFORMABLE_BODY)
...
# creat set
mdb.models['Model-1'].parts['nh_16-1'].Set(cells=
    mdb.models['Model-1'].parts['nh_16-1'].cells, name='Set-ex')
mdb.models['Model-1'].parts['nh_16-2'].Set(cells=
    mdb.models['Model-1'].parts['nh_16-2'].cells, name='Set-tube')
mdb.models['Model-1'].parts['nh_16-3'].Set(cells=
    mdb.models['Model-1'].parts['nh_16-3'].cells, name='Set-cover')
...
# SectionAssignment
mdb.models['Model-1'].parts['nh_16-1'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['nh_16-1'].sets['Set-ex'], sectionName=
    'Section-ex', thicknessAssignment=FROM_SECTION)
mdb.models['Model-1'].parts['nh_16-2'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['nh_16-2'].sets['Set-tube'], sectionName=
    'Section-tube', thicknessAssignment=FROM_SECTION)
mdb.models['Model-1'].parts['nh_16-3'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=
    mdb.models['Model-1'].parts['nh_16-3'].sets['Set-cover'], sectionName=
    'Section-cover', thicknessAssignment=FROM_SECTION)



# assembly
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='nh_16-1-1', 
    part=mdb.models['Model-1'].parts['nh_16-1'])
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='nh_16-2-1', 
    part=mdb.models['Model-1'].parts['nh_16-2'])
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='nh_16-3-1', 
    part=mdb.models['Model-1'].parts['nh_16-3'])
# merge
mdb.models['Model-1'].rootAssembly.InstanceFromBooleanMerge(domain=GEOMETRY, 
    instances=(mdb.models['Model-1'].rootAssembly.instances['nh_16-2-1'], 
    mdb.models['Model-1'].rootAssembly.instances['nh_16-3-1']), 
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-ex', side1Faces=
    mdb.models['Model-1'].rootAssembly.instances['nh_16-1-1'].faces.findAt(((
    37.292371, 0.0, 21.16105), ), ((38.059877, 88.658335, 16.255126), ), ))
...
mdb.models['Model-1'].rootAssembly.Set(faces=
    ...
    mdb.models['Model-1'].rootAssembly.instances['nh_16-1-1'].faces.findAt(((
    38.305473, -3.725, 20.04953), ), ((37.05758, -3.725, 24.776317), ), ((
    32.863078, -3.725, 29.310876), ), ((27.25256, -3.725, 31.895095), ), ((
    21.199179, -3.725, 31.479591), ), ((15.646593, -3.725, 29.435145), ), ((
    11.299047, -3.725, 25.421442), ), ((8.818417, -3.725, 20.04953), ), ((
    8.818416, -3.725, 12.95047), ), ((10.06631, -3.725, 8.223683), ), ((
    14.260813, -3.725, 3.689124), ), ((19.87133, -3.725, 1.104905), ), ((
    25.924711, -3.725, 1.52041), ), ((31.477297, -3.725, 3.564854), ), ((
    35.824843, -3.725, 7.578558), ), ((38.305473, -3.725, 12.95047), ), ), 
    name='Set-BC')
...
mdb.models['Model-1'].parts['nh_16-1'].setMeshControls(elemShape=TET, regions=
    mdb.models['Model-1'].parts['nh_16-1'].cells, technique=FREE)
mdb.models['Model-1'].parts['nh_16-1'].setElementType(elemTypes=(ElemType(
    elemCode=C3D10H, elemLibrary=STANDARD), ElemType(elemCode=C3D10H, 
    elemLibrary=STANDARD), ElemType(elemCode=C3D10H, elemLibrary=STANDARD)), 
    regions=(mdb.models['Model-1'].parts['nh_16-1'].cells, ))
mdb.models['Model-1'].parts['nh_16-1'].setElementType(elemTypes=(ElemType(
    elemCode=C3D10H, elemLibrary=STANDARD), ElemType(elemCode=C3D10H, 
    elemLibrary=STANDARD), ElemType(elemCode=C3D10H, elemLibrary=STANDARD)), 
    regions=(mdb.models['Model-1'].parts['nh_16-1'].cells, ))
mdb.models['Model-1'].parts['nh_16-1'].seedPart(deviationFactor=0.1, 
    minSizeFactor=0.1, size=1.0)
mdb.models['Model-1'].parts['nh_16-1'].generateMesh()
