...
# import part
mdb.openAcis('F:/abaqus tube/nvnh/nh20/nh20_nv7_1.SAT', scaleFromFile=ON)
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-tube', side1Faces=
    ...
    24.571767, 99.90833, 2.035206), ), ((22.552123, 99.90833, 30.964794), ), ((
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-ex', side1Faces=
    ...
    9.558756, 96.849998, 20.263072), ), ((9.082066, 8.184797, 15.736381), ), ))
...
mdb.models['Model-1'].rootAssembly.Set(faces=
    ...
    mdb.models['Model-1'].rootAssembly.instances['nh_8-1-1'].faces.findAt(((
    38.43346, -3.725, 19.467965), ), ((36.788445, -3.725, 23.918254), ), ((
    33.848727, -3.725, 27.642392), ), ((29.902068, -3.725, 30.275835), ), ((
    25.334794, -3.725, 31.560803), ), ((20.478584, -3.725, 32.028119), ), ((
    17.221822, -3.725, 30.275835), ), ((13.275163, -3.725, 27.642392), ), ((
    10.335445, -3.725, 23.918254), ), ((8.690429, -3.725, 19.467965), ), ((
    8.690429, -3.725, 13.532035), ), ((9.187078, -3.725, 9.867292), ), ((
    13.275163, -3.725, 5.357608), ), ((17.221822, -3.725, 2.724165), ), ((
    21.789096, -3.725, 1.439197), ), ((26.645306, -3.725, 0.971881), ), ((
    31.292849, -3.725, 2.684692), ), ((35.183634, -3.725, 5.749842), ), ((
    37.936812, -3.725, 9.867292), ), ((39.282875, -3.725, 14.633998), ), ), 
    name='Set-BC')
...
# # Job
jobName = 'nh20nv7-MU37' +Parameters
###############################################
