...
# import part
mdb.openAcis('F:/abaqus tube/nvnh/nh20/nh20_nv5_1.SAT', scaleFromFile=ON)
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-tube', side1Faces=
    ...
    24.571767, 98.418332, 2.035206), ), ((22.552123, 98.418332, 30.964794), ), 
    ((25.072042, 62.984999, 2.078849), ), ((22.051848, 62.984999, 30.921151), 
    ), ))
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-ex', side1Faces=
    ...
    9.556023, 93.87, 20.252887), ), ((9.064013, 11.668334, 16.255126), ), ))
...
mdb.models['Model-1'].rootAssembly.Set(faces=
    mdb.models['Model-1'].rootAssembly.instances['Part-tube-1'].faces.findAt(((
    10.45815, -5.215, 19.340962), ), )+\
    mdb.models['Model-1'].rootAssembly.instances['nh_8-1-1'].faces.findAt(((
    39.282875, -5.215, 18.366002), ), ((37.936812, -5.215, 23.132708), ), ((
    35.183634, -5.215, 27.250158), ), ((31.292849, -5.215, 30.315308), ), ((
    26.645306, -5.215, 32.028119), ), ((20.478584, -5.215, 32.028119), ), ((
    15.831041, -5.215, 30.315308), ), ((11.940254, -5.215, 27.250158), ), ((
    9.187078, -5.215, 23.132708), ), ((7.841015, -5.215, 18.366002), ), ((
    8.690429, -5.215, 13.532035), ), ((10.335445, -5.215, 9.081746), ), ((
    13.275163, -5.215, 5.357608), ), ((17.221822, -5.215, 2.724165), ), ((
    21.789096, -5.215, 1.439197), ), ((26.645306, -5.215, 0.971881), ), ((
    31.292849, -5.215, 2.684692), ), ((35.183634, -5.215, 5.749842), ), ((
    37.936812, -5.215, 9.867292), ), ((39.282875, -5.215, 14.633998), ), ), 
    name='Set-BC')
...
mdb.models['Model-1'].rootAssembly.Surface(name='Surf-cavity', side1Faces=
    mdb.models['Model-1'].rootAssembly.instances['Part-tube-1'].faces.findAt(((
    11.746775, 97.085, 18.583334), ), ((22.11737, 63.651666, 4.083752), ), ((
    25.00652, 63.651666, 28.916248), ), ((11.746775, -3.215, 14.416667), ), ))
# fluid property
...
mdb.models['Model-1'].rootAssembly.Set(edges=
    ...
    23.561945, 71.51, 31.0), )), name='Set-testline_in')

mdb.models['Model-1'].rootAssembly.Set(edges=
    mdb.models['Model-1'].rootAssembly.instances['Part-tube-1'].edges.findAt(((
    23.561945, 71.51, 2.0), )), name='Set-testline_out')
...
# # Job
jobName = 'nh20nv5-MU37' +Parameters
###############################################
